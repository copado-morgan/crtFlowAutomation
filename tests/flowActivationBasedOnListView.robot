...
${BROWSER}                chrome
${username}               morgan.schulz@va.gov.rtest
${login_url}              https://vapm--rtest.sandbox.lightning.force.com            # Salesforce instance. NOTE: Should be overwritten in CRT variables
...
Activate Flow
    ...
    Wait                 1                           #seems to be a lag in rendering the version table. Open to other ways to fix this
